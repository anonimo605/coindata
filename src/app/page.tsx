  ...
  return (
    <div className="w-full flex min-h-screen items-center justify-center py-12">
        <div className="mx-auto grid w-[380px] gap-6">
          <div className="relative mx-auto rounded-lg overflow-hidden w-[400px] h-[200px]">
            <Image
              src="https://picsum.photos/seed/finance-blue/400/200"
              alt="Las Finanzas de Sofia"
              fill
              className="object-cover"
              data-ai-hint="finance savings"
            />
            <div className="absolute inset-0 flex flex-col justify-center items-center text-center p-6 bg-gradient-to-t from-black/60 to-transparent">
              <p className="text-md italic text-white">"esta plataforma ha trasformado la manera en que manejo mis finanzas. es rapida, segura y increiblemente facil de usar"</p>
              <p className="text-sm font-semibold text-white/90 mt-2 self-end">-sofia</p>
            </div>
          </div>
