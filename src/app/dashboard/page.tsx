...
const ReferralSection = () => {
    ...
    return (
        <Card className="h-full">
            <CardHeader>
                <CardTitle className="flex items-center gap-2"><Users2 /> Invita y Gana</CardTitle>
                            ...
                            <div key={t.id} className="flex items-center">
                                <div className="flex-shrink-0">
                                    <div className={`p-2 rounded-full ${t.amount > 0 ? 'bg-green-500/10' : 'bg-red-500/10'}`}>
                                       {t.amount > 0 ? <ArrowDownLeft className="h-4 w-4 text-green-500" /> : <ArrowUpRight className="h-4 w-4 text-red-500" />}
                                    </div>
                                </div>
